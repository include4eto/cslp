...
\begin{document}
	...
	\subsection{Test inputs}
			\begin{figure}[H]
			\centering
				\includegraphics[width=.8\columnwidth]{resources/three_neighborhoods.png}
				\captionof{figure}{Effects of cache size on performance \\\textit{file: resources/three\_neighborhoods.png}}
				\label{fig:fig4}
			\end{figure}
			\begin{figure}[H]
			\centering
				\includegraphics[width=.8\columnwidth]{resources/big_cluster.png}
				\captionof{figure}{Effects of cache size on performance \\\textit{file: resources/big\_cluster.png}}
				\label{fig:fig4}
			\end{figure}
